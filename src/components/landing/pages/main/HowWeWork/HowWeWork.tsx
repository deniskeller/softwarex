          ...
          <SwiperSlide className={`${s.Slide} ${s.Slide__3}`}>
            {/* <svg
              ...
              fill="none"
							preserveAspectRatio="none"
            >
              <g filter="url(#filter0_d_1043_9186)">
                <mask id="path-1-inside-1_1043_9186" fill="white">
                ...
                />
                <path
                  d="M41 10H270V6H41V10ZM299 39V347H303V39H299ZM270 376H41V380H270V376ZM12 347V39H8V347H12ZM41 376C24.9837 376 12 363.016 12 347H8C8 365.225 22.7746 380 41 380V376ZM299 347C299 363.016 286.016 376 270 376V380C288.225 380 303 365.225 303 347H299ZM270 10C286.016 10 299 22.9837 299 39H303C303 20.7746 288.225 6 270 6V10ZM41 6C22.7746 6 8 20.7746 8 39H12C12 22.9838 24.9837 10 41 10V6Z"
                  fill="#6D6BCE"
                  fillOpacity="0.26"
                  mask="url(#path-1-inside-1_1043_9186)"
                />
              </g>
              <defs>
                <filter
                  id="filter0_d_1043_9186"
                  x="0"
                  y="0"
                  width="315"
                  height="394"
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_1043_9186"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_1043_9186"
                    result="shape"
                  />
                </filter>
              </defs>
